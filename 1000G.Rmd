...
Gnormalizer <- index_lookup(SNP_COMMON, unique(SNP_COMMON), "signature", "dense_variant_id")
Gnormalizer <- replaceNA(bind(Gnormalizer, "u", "pow((1-af)*af,0.5)"))
Gnormalizer <- redimension(Gnormalizer, sprintf("<u:double> [dense_variant_id=0:%i,1000,0]",
                                                count(SNP_COMMON)-1))
